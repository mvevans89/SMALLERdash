      ...
      dashboardPage(
        ...
        header = dashboardHeader(title = "SMALLER: Prédire le palu dans le district d'Ifanadiana",
                        ...
                        tags$li(a(href = "https://sante.gov.mg",
                                  img(src = "https://www.consolatoitaliatana.com/wp-content/uploads/2020/03/logo-ministere-sante.jpg",
                                  height = "30px"),
                                style = "padding-top:10px; padding-bottom:10px;"),
                        class = "dropdown"),
                        tags$li(a(href = "https://www.pivotworks.org/about/",
                                  img(src = "https://pivotworks.org/wp-content/uploads/2021/02/pivot_logo01.png",
                                      height = "30px"),
                                  style = "padding-top:10px; padding-bottom:10px;"),
                                class = "dropdown"),
                        tags$li(a(href = "https://www.ird.fr/",
                                  img(src = "https://upload.wikimedia.org/wikipedia/commons/7/7f/Logo_IRD_2016_BLOC_FR_COUL.png",
                                      height = "30px"),
                                  style = "padding-top:10px; padding-bottom:10px;"),
                                class = "dropdown")),
